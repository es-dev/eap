...
if(!function_exists('stristr_reverse')){
...
else
{
	...
	$strBP = stristr_reverse($strBP, 'inc/FCKeditor/editor/filemanager/browser/default/connectors/php');
	if ($strBP{strlen($strBP)-1} != "/") $strBP	.= "/";
	$strBP .= 'inc/FCKeditor/upload/';
	$GLOBALS["UserFilesPath"] = $strBP ;
}
