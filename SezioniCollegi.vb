...
Public Class SezioniCollegi
        ...
        Try
            ...
            Else
                ...
                For Each candidato As EAPModel.soraldo_ele_candidatiRow In candidati
                    ...
                    'Dim votiContestati As Integer = 0  GetVotiContestatiCandidato(IDConsultazione, IDCandidato)
    ...
    Private tableVotiSezioni As New EAPModel.VotiSezioniDataTable
    ...
    Private Sub ShowDatiBallottaggio(ByVal IDConsultazione As Integer, ByVal IDCollegio As Integer, ByVal collegio As String)
        Try
            ...
            Dim adapterGruppi As New EAPModelTableAdapters.soraldo_ele_gruppoTableAdapter
            ...
            For Each sezione As EAPModel.soraldo_ele_sezioniRow In sezioni.Rows
                Dim numeroSezione As Integer = sezione.num_sez
                Dim IDSezione As Integer = sezione.id_sez
                Dim row As EAPModel.VotiSezioniRow = tableVotiSezioni.NewVotiSezioniRow
    ...
    Private Function GetVotiSezione(ByVal IDConsultazione As Integer, ByVal IDSezione As Integer, ByVal IDGruppo As Integer) As Integer
        Try
            ...
            If (voti.Rows.Count >= 1) Then
                Dim voto As EAPModel.soraldo_ele_voti_gruppoRow = voti.Rows(0)
